...
var myVar = setInterval(function(){ var usmsgw = $(".pmsgc").length;if(usmsgw > 0){
   $(`
	<div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      ...
      <div class="uzr fl" style="padding:0px;width:45%">
		...
		<div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: right;display: block;margin-top: -17px;" class=" u-msg   break  fl"> مرحباً بك 👋 <h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1>  في بيتك الثاني ونقدر تواجدك معنا نتمنى لك ان تحضى برفقة رائعه معنا فشكراً لتواجدك بيننا   </div>
      </div>
    </div></div>
	`).appendTo('div#d2')
clearInterval(myVar);
